...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'protecc_datos' => [
            'required' => 'Debe confirmar que el usuario ha aceptado el tratamiento de sus datos.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        'tipo_id' => 'tipo',
        'tramites' => 'trámites',
        'usuario.municipio_id' => 'municipio',
        'usuario.paisorigen_id' => 'país de origen',
        'usuario.paisnacionalidad_id' => 'nacionalidad',
        'fecha_nacimiento' => 'fecha de nacimiento',
        'doc_identif' => 'documento de identidad',
        'protecc_datos' => 'protección de datos',
        'num expediente' => 'número de expediente',
        'fecha_registro' => 'fecha de registro',
        'municipio_id' => 'municipio',
        'paisorigen_id' => 'país de origen',
        'paisnacionalidad_id' => 'nacionalidad',
    ],
